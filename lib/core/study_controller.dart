...
class StudyController extends ChangeNotifier
  ...
  Future<void> addChapterToStudyFile(
    ...
    // them across the in-memory round-trip (the Lichess-style chapter tags
    // are regenerated by StudyChapter.toPgn).
    ...
    if (_doc.filePath == path) {
      ...
      final chapterPgn = chapter.toPgn(
        studyName: p.basenameWithoutExtension(path),
      );
