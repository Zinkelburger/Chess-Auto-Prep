...
enum RepertoireMode { edit, analyze }
...
enum AnalyzeTab { lines, coverage, traps, evalTree }

/// Main analyze work area: lines list vs coverage-focused view.
enum AnalyzeMainView { lines, coverage }

/// Analyze context detail pane beside the board / main zone.
enum AnalyzeContextView { traps, evalTree, metrics }
