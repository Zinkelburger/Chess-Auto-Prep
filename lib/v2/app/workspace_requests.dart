...
final class WorkspaceRequests extends ChangeNotifier {
  ...
  /// then opened in the viewer at the ply the explorer was showing.
  Future<RequestResult> openExplorerGame(ExplorerGame game) async {
    final kept = await _explorer.keepGame(game);
    if (_disposed) return const RequestDropped();
    switch (kept) {
