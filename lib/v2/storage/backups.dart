...
final class BackupArchive {
  ...
  /// Carries the history along; never fails the move ([BackupRelocation]).
  Future<void> applyMove(BackupMove move, {required Directory documents}) =>
      BackupRelocation(root, documents: documents).applyMove(move);
