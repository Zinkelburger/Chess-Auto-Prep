...
class _BrowseFilterBar extends StatelessWidget {
  ...
  /// Every chip, the sort and the search box in one value; each control
  /// hands back a [TacticsBrowseFilter.copyWith] of it.
  final TacticsBrowseFilter filter;
  final ValueChanged<TacticsBrowseFilter> onFilterChanged;
