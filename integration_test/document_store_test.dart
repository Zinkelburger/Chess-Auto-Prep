    ...
    (tester) async {
      ...
      final repository = LegacyRepertoireCatalogRepository(
        ...
        documents: NativePgnDocumentStore(
          flushDirectory: (_) async => throw const FileSystemException(
            'Injected namespace flush failure',
          ),
        ),
      );
      ...
      final message = find.text(const RepertoireCreationUncertain().toString());
