...
void main() {
  ...
  test(
    'an unreadable sibling is retried instead of cached as answering nothing',
    () async {
      final main = ref('KID', 'Main');
      final sibling = ref('KID', 'Sicilian');
      final store = ScriptedDocumentStore()
        ..documents[sibling] = const Unreadable('held unavailable');
      final answers = RepertoireAnswers(
        files: ScriptedFiles(
          listing: Repertoires([
