...
BuildTreeNode _attachTrap(BuildTreeNode parent, String trapFen, int idBase) {
  final trap =
      BuildTreeNode(
          fen: trapFen,
          moveSan: 'd4',
...
void main() {
  group('trap position identity', () {
    test('index finds a trap regardless of move counters', () {
      ...
      expect(
        index.trapAtFen(_fenCountersA),
        isNotNull,
        reason: 'exact FEN should hit',
      );
      expect(
        index.trapAtFen(_fenCountersB),
        isNotNull,
    ...
    test(
      'canonicalizeFen4 treats the two counter variants as one position',
      () {
        expect(
          canonicalizeFen4(_fenCountersA),
          canonicalizeFen4(_fenCountersB),
        );
      },
    );
