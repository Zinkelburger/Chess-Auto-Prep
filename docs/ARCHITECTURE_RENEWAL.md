...
| Builder editor and orphan layout retired (`1c0514f2`, `2ead1e6c`); integration checks in progress | Builder directly composes its existing editor; unused layout implementations are deleted | Nine files removed, net −1,887 production lines across both reviewed scopes. Existing clipboard, annotation, title, branch undo, editor identity and Viewer splitter retained. Whole Builder renewal remains Partial. |
