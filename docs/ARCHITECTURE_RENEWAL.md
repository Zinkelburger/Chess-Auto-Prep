...
| 4b | **Study.** Study mode over the same workspace: the Documents `studies/` files, one game per chapter, Lichess study import and export, quiz markers. | Screenshot | Not started |
