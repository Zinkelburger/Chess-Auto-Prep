...
applies them and removes the record. After a crash the recovery gate finishes
each record on the next access, re-planning training rows and book selectors
that changed meanwhile, or quarantines it (see
