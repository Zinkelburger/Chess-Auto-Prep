...
The same measurement at selected-document-store checkpoint `654898bf`, including
reviewed settings and Study chapter-list consolidation, is:

| Tracked scope | September 16 | Current checkpoint | Change from September 16 |
|---|---:|---:|---:|
| All library Dart, including generated code | 218,957 | 225,716 | +6,759 (+3.1%) |
...
All-library code is down 11,275 lines from the reviewed `a6238ff5` snapshot,
...
removes 14,011 handwritten library lines, with generated localization +245
