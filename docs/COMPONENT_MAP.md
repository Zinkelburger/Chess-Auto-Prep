...
| `generation/eca_calculator.dart` | Expectimax + trap scores + CPL value propagation (opponent-mistake weight) |
| `generation/repertoire_selector.dart` | Mark repertoire moves on tree (3 objectives; novelty/mistake weights and tie-breaks on top) |
