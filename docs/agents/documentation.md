...
| `docs/ARCHITECTURE_RENEWAL.md` | Canonical rewrite plan, selected decisions and milestone evidence; keep future requirements distinct from implemented behavior |
